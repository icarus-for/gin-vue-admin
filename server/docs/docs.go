...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/orders/checkout/apply-coupon": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/orders/checkout/remove-coupon": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/orders/checkout/remove-points": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/orders/checkout/use-points": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/products/favorites/delete": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/products/favorites/skus": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "每页数量（默认 10，最大100）",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "排序方式（newest, oldest）",
                        "name": "sort",
                        "in": "query"
                    }
                ],
        ...
        "/api/v1/products/questions": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "排序方式（newest, oldest, most_helpful）",
                        "name": "sort",
                        "in": "query"
                    }
                ],
        ...
        "/api/v1/products/reviews": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "排序方式（newest, oldest, highest_rating, lowest_rating, most_helpful）",
                        "name": "sort",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "星级筛选（1～5）",
                        "name": "rating",
                        "in": "query"
                    }
                ],
        ...
        "/api/v1/shipping-addresses/change": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
